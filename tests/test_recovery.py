...
class RecoveryTests(unittest.TestCase):
    ...
    def test_root_serves_full_field_app_by_default(self) -> None:
        ...
        self.assertIn("enhancements.js?v=cards48", full_app)
    ...
    def test_capture_perf_markers_present(self) -> None:
        ...
        self.assertIn('CLEANRUN_FRONTEND_BUILD="cards48"', enhancements)
        ...
        self.assertIn("markupPhotoRef", enhancements)
        ...
        self.assertIn("read_markup_bytes", main)
