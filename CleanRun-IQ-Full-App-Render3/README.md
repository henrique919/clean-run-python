...
- Retrospective photo evidence, GPS metadata, enlargement and markup tools
- Responsive desktop administration with expanded management views
...
- Branded report previews with printable multi-photo evidence galleries
- Offline app shell, cached register and IndexedDB-backed field change queue
