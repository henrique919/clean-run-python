...
class FullFieldAppTests(unittest.TestCase):
    ...
    def test_photo_validation_reports_and_complete_taskbar_ui(self) -> None:
        ...
        self.assertIn("enhancements.css?v=cards15", page)
        self.assertIn("enhancements.js?v=cards15", page)
    ...
    def test_photo_admin_report_and_offline_enhancements(self) -> None:
        ...
        self.assertIn("border-left:18px solid", styles)
        ...
        self.assertIn("cleanrun-iq-shell-v15", worker)
