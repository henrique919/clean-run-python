...
class FullFieldAppTests(unittest.TestCase):
    ...
    def test_photo_validation_reports_and_complete_taskbar_ui(self) -> None:
        ...
        self.assertIn("enhancements.css?v=cards16", page)
        self.assertIn("enhancements.js?v=cards16", page)
    ...
    def test_photo_admin_report_and_offline_enhancements(self) -> None:
        ...
        self.assertIn("border-left:5px solid", styles)
        self.assertIn(".cr-card-band", styles)
        self.assertIn("background:#E5E7EB", styles)
        ...
        self.assertIn("cleanrun-iq-shell-v16", worker)
