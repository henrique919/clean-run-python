...
def build_report(items: list[Item], settings: Settings, report_type: str, *, subcontractor: str | None = None, projects: list[str] | None = None) -> str:
    return build_report_html(items, settings, report_type=report_type, subcontractor=subcontractor, projects=projects)
