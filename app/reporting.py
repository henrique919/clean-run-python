...
def photo_cell(value: str | None, caption: str | None = None, by: str | None = None, *, alt: str = "Evidence photo", at: str | None = None, compact: bool = False) -> str:
    ...
    at_html = f'<div class="time">{escape(at)}</div>' if at else ""
