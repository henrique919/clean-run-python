...
def evidence_block(title: str, body: str, *, kind: str) -> str:
    return f'<section class="evidence-block {kind}"><div class="evidence-title">{escape(title)}</div>{body}</section>'
...
.status-badge.status-open{{background:#F4F6F8;color:#52606D;border-color:#DDE3E8}}.status-badge.status-ready-for-review,.status-badge.status-under-inspection{{background:#E8F0FF;color:#1D4ED8;border-color:#BFD4FF}}.status-badge.status-in-progress{{background:#FFF0E0;color:#9A4A00;border-color:#F0D0A8}}.status-badge.status-overdue{{background:#FDECEC;color:#8B1E1E;border-color:#F5C2C2}}.status-badge.status-closed,.status-badge.status-complete{{background:#EAFBF1;color:#0B6E36;border-color:#BFE8D0}}.status-badge.status-issued{{background:#FFF4DF;color:#8A5A00;border-color:#F0D7A4}}.item-head{{display:flex;justify-content:space-between;gap:10px;align-items:start}}.code{{font-size:16px;font-weight:800;line-height:1}}.type{{color:#69747D;font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.45px;margin-top:2px}}.status-badge{{font-size:9px;font-weight:900;padding:4px 7px;border:1px solid #DDE3E8;background:#F4F6F8;text-transform:uppercase;border-radius:999px}}.status-badge.status-closed,.status-badge.status-complete{{background:#EAFBF1;color:#0B6E36}}.status-badge.status-rejected{{background:#FDECEC;color:#8B1E1E}}.register-line{{display:grid;grid-template-columns:1.25fr 1fr .75fr;gap:6px;color:#69747D;font-size:10px;margin-top:7px}}.register-line span{{background:#F4F6F8;border:1px solid #DDE3E8;padding:5px 6px;border-radius:6px}}.desc{{font-size:12px;margin:8px 0}}.evidence-pack{{display:flex;flex-direction:column;gap:14px;margin-top:10px}}.evidence-block{{break-inside:avoid;page-break-inside:avoid}}.evidence-title{{color:#69747D;font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:.45px;margin:0 0 8px;padding-bottom:5px;border-bottom:2px solid #DDE3E8}}.evidence-block.original .evidence-title{{border-bottom-color:#161A1D}}.evidence-block.rectification .evidence-title{{border-bottom-color:#B66A14}}.evidence-block.closeout .evidence-title{{border-bottom-color:#26C66A}}.project-block{{margin-top:18px;break-inside:avoid;page-break-inside:avoid}}.project-heading{{font-size:17px;color:#283238;border-bottom:2px solid #26C66A;padding-bottom:5px;margin:0 0 10px}}.photo-stack{{display:flex;flex-direction:column;gap:12px;break-inside:avoid;page-break-inside:avoid}}.photo{{background:#fff;border:1px solid #DDE3E8;padding:6px;font-size:9px;border-radius:8px;break-inside:avoid;page-break-inside:avoid;width:100%}}.photo img{{display:block;width:100%;height:auto;max-height:420px;object-fit:contain;object-position:center;background:#F4F6F8;border-radius:6px;margin-bottom:5px;break-inside:avoid;page-break-inside:avoid}}.photo.portrait img{{max-height:min(72vh,680px)}}.photo.landscape img{{max-height:420px}}.photo.seed{{background:#fff}}.by,.time{{color:#69747D;font-size:8px;margin-top:2px}}.none{{color:#69747D;font-size:10px;border:1px dashed #B8C0C8;background:#fff;padding:8px;border-radius:6px}}.none.evidence-empty{{padding:7px 8px;font-size:9px}}.none.block{{padding:10px;background:#F4F6F8;border-radius:8px}}.signoff{{color:#0B6E36;font-weight:800;font-size:11px;margin-top:7px}}.meta-line{{display:flex;gap:5px;align-items:center;margin-top:7px;flex-wrap:wrap}}.ev{{font-size:8px;font-weight:900;padding:3px 6px;border:1px solid #DDE3E8;background:#fff;text-transform:uppercase;border-radius:999px}}.ev.closeout{{background:#EAFBF1}}.ev.rectification{{background:#FFF4DF}}.due{{margin-left:auto;font-size:9px;color:#69747D;font-weight:800}}.due.overdue{{color:#C73535}}.footer{{margin-top:18px;padding-top:10px;border-top:1px solid #DDE3E8;text-align:center;color:#69747D;font-size:9px;letter-spacing:.4px;font-weight:800}}@media print{{body{{background:#fff}}.report-actions{{display:none}}.report-shell{{border:0;padding:0;max-width:none}}.report-section,.project-block,.group,.item,.item-head,.evidence-pack,.evidence-block,.photo-stack,.photo,.photo img,.meta-line{{break-inside:avoid;page-break-inside:avoid}}.photo.portrait img{{max-height:240mm}}.photo.landscape img{{max-height:120mm}}.item{{margin-top:6px}}}}
