...
def report_share_filename(settings: Settings, report_type: str) -> str:
    project = re.sub(r"[^A-Za-z0-9]+", "-", (settings.active_project or "Project").strip()).strip("-") or "Project"
...
def build_report_html(items: list[Item], settings: Settings, report_type: str = "handover", *, subcontractor: str | None = None) -> str:
    ...
    share_filename = report_share_filename(settings, report_type)
